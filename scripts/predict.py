...
# Prometheus metrics
REQUEST_COUNT = Counter('prediction_request_count', 'Number of prediction requests received')
PREDICTION_DURATION = Gauge('prediction_duration_seconds', 'Time spent making a prediction')
